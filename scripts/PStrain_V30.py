...
def check_input(args):
    ...
    if not os.path.isdir(args.bowtie2db):
        print (f"Metaphlan database {args.bowtie2db} is detected.")
...
def main():
    ...
    Example: python3 PStrain_V30.py -c config.txt -o outdir/ --bowtie2db ../mpa_v31_CHOCOPhlAn_201901/ -x mpa_v31_CHOCOPhlAn_201901
    ...
    parser = ArgumentParser(description="PStrain: profile strains in shotgun metagenomic sequencing reads.",prog='python3 PStrain_V30.py',usage=Usage, formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    ...
    required.add_argument("--bowtie2db",help="Path to metaphlan bowtie2db.",metavar='',\
        default=scripts_dir+'../mpa_v31_CHOCOPhlAn_201901')
    required.add_argument("-x", "--metaphlan_index",help="Path to metaphlan bowtie2db index.",metavar='',\
        default='mpa_v31_CHOCOPhlAn_201901')
