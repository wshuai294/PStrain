...
do
    for i in {0..49}
        ...
        echo $k $i
        sample=gene_k${k}_${i}
        prefix="/mnt/disk2_workspace/wangshuai/00.strain/18.revision_PStrain/DATA/snp_num/snp1200/$sample/$sample" 
        path="/mnt/disk2_workspace/wangshuai/00.strain/18.revision_PStrain/DATA/snp_num/snp1200/$sample/" 
    
        #generate snps refs
        mkdir $path
        cd $path
        /home/wangshuai/softwares/GemSIM_v1.6/GemHaps.py -r /home/wangshuai/strain/04.refs/metaphlan/phlan2.fa -g '1,1200' 
        #Simulating step
